      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active">
            <img src="images/standard-room-1.jpg" alt="" style="width:100%;">
          </div>

          <div class="item">
            <img src="images/standard-room-2.jpg" alt="" style="width:100%;">
          </div>

          <div class="item">
            <img src="images/standard-room-3.jpg" alt="" style="width:100%;">
          </div>
        </div>
