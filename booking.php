...
$db->query("INSERT INTO feature (name, room_id, butler, breakfast, massage) VALUES ('$_SESSION[username]', $last_room_id + 1, '$_SESSION[butler]', '$_SESSION[breakfast]', '$_SESSION[massage]')");
